...
//
//	private List<BlockFunction> timedOps = Collections.emptyList();
//	private List<OperationHandler<TimedOperation>> timedHandlers = Collections.emptyList();
//	private List<BlockFunction> auraOps = Collections.emptyList();
...
//	}
//	
//	public void setAuras(BlockFunction... auras) {
...
//	}
//	
//	public void setOperations(BlockFunction... operations) {
...
//		BlockFunction timedOp = timedOps.get(opIndex);
...
//		BlockFunction aura = auraOps.get(opIndex);
